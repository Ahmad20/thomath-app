...
class WaliMuridController extends Controller
{
    ...
    public function dashboard(){
        ...
        $konsultasi = $wali->konsultasi;
        return view('wali.dashboard', ['wali'=>$wali, 'konsultasi'=>$konsultasi]);
    }
    /**
    ...
    public function editPassword(){
        return view('wali.editpassword');
    }
    public function updatePassword(Request $request, $id_wali){
        ...
        return redirect()->intended('walimurid/dashboard')->with('success', 'Password berhasil diubah');
    ...
    public function updateProfile(Request $request, $id_wali){
        ...
        $wali->update($data);
        return redirect()->intended('walimurid/dashboard')->with('success', 'Profile berhasil diubah');
    }
}
    // public function updateProfile(Request $request, $id_wali){
    //     $data = [
