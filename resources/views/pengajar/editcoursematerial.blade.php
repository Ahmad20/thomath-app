...
<body id="body-pd">
    ...
    <div class="height-100">
        <form method="POST" action='/pengajar/course-material/update/{{ $material->id_course_material }}'>
            @csrf
            <form>
