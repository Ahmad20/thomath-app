...
<body id="body-pd">
    ...
    <div class="height-100">
        <form method="post" action="/pengajar/test/update/{{ $testpaper->id_testpaper }}">
            @csrf
            ...
            <div class="form-group row m-3">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name='testname' id='testname' value="{{ $testpaper->name }}" />
                    @error('testname')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group row m-3">
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" name="question" id="question">{{ $testpaper->question }}</textarea>
                    @error('question')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
